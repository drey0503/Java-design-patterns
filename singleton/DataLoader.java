...
/**
 * Used to read exteral data for the program Questions from:
 * https://www.rd.com/list/trivia-questions-for-kids/
 */
public class DataLoader {
    ...
    /**
     * third Returns a list of all trivia questions from the text file
     * 
